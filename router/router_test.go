...
var dummyPaths = []Path{
	...
	{
		Pattern:  "/tiger/:tiger_id/:catch*",
		Segments: &[]string{"tiger", ":tiger_id", ":catch*"},
		PathType: "non-ultimate-splat",
	},
	{
	...
	{
		Pattern:  "/dynamic-index/:pagename",
		Segments: &[]string{"dynamic-index", ":pagename", ""},
		PathType: "index",
	},
	{
		Pattern:  "/dashboard/:catch*",
		Segments: &[]string{"dashboard", ":catch*"},
		PathType: "non-ultimate-splat",
	},
	{
		Pattern:  "/dashboard",
	...
	{
		Pattern:  "/bear/:bear_id/:catch*",
		Segments: &[]string{"bear", ":bear_id", ":catch*"},
		PathType: "non-ultimate-splat",
	},
	{
		Pattern:  "/articles",
